...
\bigskip
\begin{abstract}
The nearest-neighbor search is a classic computational challenge that has applications within many fields, including predictive modeling. It is important to consider how the computational requirements of statistical learning methods scale with increasing data sizes. Approximate nearest-neighbors algorithms exist to improve the speed at which queries are able to run by pre-processing training data for efficient searches using tree-based structures. We propose \textit{iterative quantile nearest-neighbor} (IQNN) models for classification and regression that provides a rough approximation to $k$-nearest-neighborhood models through the use of an iterative process of partitioning the feature space using empirical quantiles of feature variables, which are then stored as an R-tree of intervals. IQNN models demonstrate comparable predictive accuracy with KNN methods in empirical trials on many data sets and is shown through repeated simulation to be considerably more computationally efficient in cases with very large sample sizes. 
\end{abstract}
...
\hline 
  iris & 150 & \html{http://archive.ics.uci.edu/ml/machine-learning-databases/iris} \\ 
  wpbc & 198 & \html{http://archive.ics.uci.edu/ml/machine-learning-databases/breast-cancer-wisconsin} \\ 
  pima & 768 & \html{http://archive.ics.uci.edu/ml/machine-learning-databases/pima-indians-diabetes} \\
  yeast & 1484 & \html{http://archive.ics.uci.edu/ml/machine-learning-databases/yeast} \\ 
  abalone & 4174 & \html{http://archive.ics.uci.edu/ml/machine-learning-databases/abalone} \\ 
  waveform & 5000 & \html{http://archive.ics.uci.edu/ml/machine-learning-databases/waveform} \\ 
  optdigits & 5620 & \html{http://sci2s.ugr.es/keel/dataset.php?cod=199} \\ 
  satimage & 6435 & \html{http://sci2s.ugr.es/keel/dataset.php?cod=71} \\ 
  marketing & 8494 & \html{http://sci2s.ugr.es/keel/dataset.php?cod=163} \\
  seizure & 11500 & \html{http://archive.ics.uci.edu/ml/machine-learning-databases/00388} \\ 
\hline 
 & & \\
\textbf{Regression} & & \\ 
\hline 
...
\hline 
  wpbc & 198 &  \html{http://archive.ics.uci.edu/ml/machine-learning-databases/breast-cancer-wisconsin} \\ 
  wankara & 321 &  \html{http://sci2s.ugr.es/keel/category.php?cat=reg?cod=41} \\ 
  laser & 993 &  \html{http://sci2s.ugr.es/keel/category.php?cat=reg?cod=47} \\ 
  treasury & 1049 &  \html{http://sci2s.ugr.es/keel/category.php?cat=reg?cod=42} \\
  quake & 2178 &  \html{http://sci2s.ugr.es/keel/category.php?cat=reg?cod=75} \\ 
  skillcraft & 3395 &  \html{http://archive.ics.uci.edu/ml/machine-learning-databases/00272} \\
  anacalt & 4052 &  \html{http://sci2s.ugr.es/keel/category.php?cat=reg?cod=159} \\
  puma & 8192 &  \html{http://sci2s.ugr.es/keel/category.php?cat=reg?cod=1291} \\
  air quality & 9357 &  \html{http://archive.ics.uci.edu/ml/machine-learning-databases/00360} \\
  ccpp & 9568 &  \html{http://archive.ics.uci.edu/ml/machine-learning-databases/00294} \\
   \hline
\end{tabular}
