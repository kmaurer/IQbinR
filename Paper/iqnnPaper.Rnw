...
<<sim_time, echo=F,include=T,eval=T,fig.width=9, fig.height=3, out.width='.99\\linewidth', fig.pos='h',fig.align='center',tidy=F, cache=TRUE, fig.show='hold',fig.cap="Sim Sample times...",warning=FALSE, message=FALSE>>=
